...
let g:colors_name="desert256-TjlH"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    fun <SID>X(group, fg, bg, attr)	" {{{
        ...
        if a:bg != ""
	    if &background == "dark" && a:bg == "000000"
		exec "hi " . a:group . " guibg=#000000 ctermbg=NONE"
	    else
    ...
    hi DiffDelete	ctermbg=darkred ctermfg=lightred
    hi DiffChange	ctermbg=darkgrey
    hi DiffText		ctermbg=darkmagenta
endif
